...
<p align="center">
  ...
  <a href="https://github.com/anomalyco/GTAQCODE/actions/workflows/publish.yml"><img alt="à¸ªà¸–à¸²à¸™à¸°à¸à¸²à¸£à¸ªà¸£à¹‰à¸²à¸‡" src="https://img.shields.io/github/actions/workflow/status/anomalyco/GTAQCODE/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
npm i -g GTAQCODE-ai@latest        # à¸«à¸£à¸·à¸­ bun/pnpm/yarn
scoop install GTAQCODE             # Windows
choco install GTAQCODE             # Windows
brew install anomalyco/tap/GTAQCODE # macOS à¹à¸¥à¸° Linux (à¹à¸™à¸°à¸™à¸³ à¸­à¸±à¸›à¹€à¸”à¸•à¹€à¸ªà¸¡à¸­)
brew install GTAQCODE              # macOS à¹à¸¥à¸° Linux (brew formula à¸­à¸¢à¹ˆà¸²à¸‡à¹€à¸›à¹‡à¸™à¸—à¸²à¸‡à¸à¸²à¸£ à¸­à¸±à¸›à¹€à¸”à¸•à¸™à¹‰à¸­à¸¢à¸à¸§à¹ˆà¸²)
sudo pacman -S GTAQCODE            # Arch Linux (Stable)
paru -S GTAQCODE-bin               # Arch Linux (Latest from AUR)
mise use -g GTAQCODE               # à¸£à¸°à¸šà¸šà¸›à¸à¸´à¸šà¸±à¸•à¸´à¸à¸²à¸£à¹ƒà¸”à¸à¹‡à¹„à¸”à¹‰
nix run nixpkgs#GTAQCODE           # à¸«à¸£à¸·à¸­ github:anomalyco/GTAQCODE à¸ªà¸³à¸«à¸£à¸±à¸šà¸ªà¸²à¸‚à¸²à¸žà¸±à¸’à¸™à¸²à¸¥à¹ˆà¸²à¸ªà¸¸à¸”
```
...
GTAQCODE à¸¡à¸µà¹ƒà¸«à¹‰à¹ƒà¸Šà¹‰à¸‡à¸²à¸™à¹€à¸›à¹‡à¸™à¹à¸­à¸›à¸žà¸¥à¸´à¹€à¸„à¸Šà¸±à¸™à¹€à¸”à¸ªà¸à¹Œà¸—à¹‡à¸­à¸› à¸”à¸²à¸§à¸™à¹Œà¹‚à¸«à¸¥à¸”à¹‚à¸”à¸¢à¸•à¸£à¸‡à¸ˆà¸²à¸ [à¸«à¸™à¹‰à¸²à¸£à¸¸à¹ˆà¸™](https://github.com/anomalyco/GTAQCODE/releases) à¸«à¸£à¸·à¸­ [GTAQCODE.ai/download](https://GTAQCODE.ai/download)
...
1. `$GTAQCODE_INSTALL_DIR` - à¹„à¸”à¹€à¸£à¸à¸—à¸­à¸£à¸µà¸à¸²à¸£à¸•à¸´à¸”à¸•à¸±à¹‰à¸‡à¸—à¸µà¹ˆà¸à¸³à¸«à¸™à¸”à¹€à¸­à¸‡
...
4. `$HOME/.GTAQCODE/bin` - à¸„à¹ˆà¸²à¸ªà¸³à¸£à¸­à¸‡à¹€à¸£à¸´à¹ˆà¸¡à¸•à¹‰à¸™
...
GTAQCODE à¸£à¸§à¸¡à¹€à¸­à¹€à¸ˆà¸™à¸•à¹Œà¹ƒà¸™à¸•à¸±à¸§à¸ªà¸­à¸‡à¸•à¸±à¸§à¸—à¸µà¹ˆà¸„à¸¸à¸“à¸ªà¸²à¸¡à¸²à¸£à¸–à¸ªà¸¥à¸±à¸šà¹„à¸”à¹‰à¸”à¹‰à¸§à¸¢à¸›à¸¸à¹ˆà¸¡ `Tab`
...
à¹€à¸£à¸µà¸¢à¸™à¸£à¸¹à¹‰à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡à¹€à¸à¸µà¹ˆà¸¢à¸§à¸à¸±à¸š [à¹€à¸­à¹€à¸ˆà¸™à¸•à¹Œ](https://GTAQCODE.ai/docs/agents)

### à¹€à¸­à¸à¸ªà¸²à¸£à¸›à¸£à¸°à¸à¸­à¸š

à¸ªà¸³à¸«à¸£à¸±à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡à¹€à¸à¸µà¹ˆà¸¢à¸§à¸à¸±à¸šà¸§à¸´à¸˜à¸µà¸à¸³à¸«à¸™à¸”à¸„à¹ˆà¸² GTAQCODE [**à¹„à¸›à¸—à¸µà¹ˆà¹€à¸­à¸à¸ªà¸²à¸£à¸‚à¸­à¸‡à¹€à¸£à¸²**](https://GTAQCODE.ai/docs)

### à¸à¸²à¸£à¸¡à¸µà¸ªà¹ˆà¸§à¸™à¸£à¹ˆà¸§à¸¡

à¸«à¸²à¸à¸„à¸¸à¸“à¸ªà¸™à¹ƒà¸ˆà¸—à¸µà¹ˆà¸ˆà¸°à¸¡à¸µà¸ªà¹ˆà¸§à¸™à¸£à¹ˆà¸§à¸¡à¹ƒà¸™ GTAQCODE à¹‚à¸›à¸£à¸”à¸­à¹ˆà¸²à¸™ [à¹€à¸­à¸à¸ªà¸²à¸£à¸à¸²à¸£à¸¡à¸µà¸ªà¹ˆà¸§à¸™à¸£à¹ˆà¸§à¸¡](./CONTRIBUTING.md) à¸à¹ˆà¸­à¸™à¸ªà¹ˆà¸‡ Pull Request

### à¸à¸²à¸£à¸ªà¸£à¹‰à¸²à¸‡à¸šà¸™ GTAQCODE

à¸«à¸²à¸à¸„à¸¸à¸“à¸—à¸³à¸‡à¸²à¸™à¹ƒà¸™à¹‚à¸›à¸£à¹€à¸ˆà¸à¸•à¹Œà¸—à¸µà¹ˆà¹€à¸à¸µà¹ˆà¸¢à¸§à¸‚à¹‰à¸­à¸‡à¸à¸±à¸š GTAQCODE à¹à¸¥à¸°à¹ƒà¸Šà¹‰ "GTAQCODE" à¹€à¸›à¹‡à¸™à¸ªà¹ˆà¸§à¸™à¸«à¸™à¸¶à¹ˆà¸‡à¸‚à¸­à¸‡à¸Šà¸·à¹ˆà¸­ à¹€à¸Šà¹ˆà¸™ "GTAQCODE-dashboard" à¸«à¸£à¸·à¸­ "GTAQCODE-mobile" à¹‚à¸›à¸£à¸”à¹€à¸žà¸´à¹ˆà¸¡à¸«à¸¡à¸²à¸¢à¹€à¸«à¸•à¸¸à¹ƒà¸™ README à¸‚à¸­à¸‡à¸„à¸¸à¸“à¹€à¸žà¸·à¹ˆà¸­à¸Šà¸µà¹‰à¹à¸ˆà¸‡à¸§à¹ˆà¸²à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¸ªà¸£à¹‰à¸²à¸‡à¹‚à¸”à¸¢à¸—à¸µà¸¡ GTAQCODE à¹à¸¥à¸°à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¹€à¸à¸µà¹ˆà¸¢à¸§à¸‚à¹‰à¸­à¸‡à¸à¸±à¸šà¹€à¸£à¸²à¹ƒà¸™à¸—à¸²à¸‡à¹ƒà¸”

---

**à¸£à¹ˆà¸§à¸¡à¸Šà¸¸à¸¡à¸Šà¸™à¸‚à¸­à¸‡à¹€à¸£à¸²** [Discord](https://discord.gg/GTAQCODE) | [X.com](https://x.com/GTAQCODE)
