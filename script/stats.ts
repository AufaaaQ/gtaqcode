...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/GTAQCODE/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/GTAQCODE...\n")
...
console.log("Fetching npm all-time downloads for GTAQCODE-ai...\n")
const npmDownloads = await fetchNpmDownloads("GTAQCODE-ai")
