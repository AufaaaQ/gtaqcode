...
Generates UPCOMING_CHANGELOG.md by running the GTAQCODE changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for GTAQCODE run (default: low)
      --quiet            Suppress GTAQCODE command output unless it fails
