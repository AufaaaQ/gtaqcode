...
npm i -g GTAQCODE-ai@latest        # hoáº·c bun/pnpm/yarn
scoop install GTAQCODE             # Windows
choco install GTAQCODE             # Windows
brew install anomalyco/tap/GTAQCODE # macOS vÃ  Linux (khuyÃªn dÃ¹ng, luÃ´n cáº­p nháº­t)
brew install GTAQCODE              # macOS vÃ  Linux (cÃ´ng thá»©c brew chÃ­nh thá»©c, Ã­t cáº­p nháº­t hÆ¡n)
sudo pacman -S GTAQCODE            # Arch Linux (Báº£n á»•n Ä‘á»‹nh)
paru -S GTAQCODE-bin               # Arch Linux (Báº£n má»›i nháº¥t tá»« AUR)
mise use -g GTAQCODE               # Má»i há»‡ Ä‘iá»u hÃ nh
nix run nixpkgs#GTAQCODE           # hoáº·c github:anomalyco/GTAQCODE cho nhÃ¡nh dev má»›i nháº¥t
```
...
GTAQCODE cÅ©ng cÃ³ sáºµn dÆ°á»›i dáº¡ng á»©ng dá»¥ng desktop. Táº£i trá»±c tiáº¿p tá»« [trang releases](https://github.com/anomalyco/GTAQCODE/releases) hoáº·c [GTAQCODE.ai/download](https://GTAQCODE.ai/download).
...
1. `$GTAQCODE_INSTALL_DIR` - ThÆ° má»¥c cÃ i Ä‘áº·t tÃ¹y chá»‰nh
...
4. `$HOME/.GTAQCODE/bin` - Máº·c Ä‘á»‹nh dá»± phÃ²ng
...
GTAQCODE bao gá»“m hai agent Ä‘Æ°á»£c tÃ­ch há»£p sáºµn mÃ  báº¡n cÃ³ thá»ƒ chuyá»ƒn Ä‘á»•i báº±ng phÃ­m `Tab`.
...
TÃ¬m hiá»ƒu thÃªm vá» [agents](https://GTAQCODE.ai/docs/agents).

### TÃ i liá»‡u

Äá»ƒ biáº¿t thÃªm thÃ´ng tin vá» cÃ¡ch cáº¥u hÃ¬nh GTAQCODE, [**hÃ£y truy cáº­p tÃ i liá»‡u cá»§a chÃºng tÃ´i**](https://GTAQCODE.ai/docs).

### ÄÃ³ng gÃ³p

Náº¿u báº¡n muá»‘n Ä‘Ã³ng gÃ³p cho GTAQCODE, vui lÃ²ng Ä‘á»c [tÃ i liá»‡u hÆ°á»›ng dáº«n Ä‘Ã³ng gÃ³p](./CONTRIBUTING.md) trÆ°á»›c khi gá»­i pull request.

### XÃ¢y dá»±ng trÃªn ná»n táº£ng GTAQCODE

Náº¿u báº¡n Ä‘ang lÃ m viá»‡c trÃªn má»™t dá»± Ã¡n liÃªn quan Ä‘áº¿n GTAQCODE vÃ  sá»­ dá»¥ng "GTAQCODE" nhÆ° má»™t pháº§n cá»§a tÃªn dá»± Ã¡n, vÃ­ dá»¥ "GTAQCODE-dashboard" hoáº·c "GTAQCODE-mobile", vui lÃ²ng thÃªm má»™t ghi chÃº vÃ o README cá»§a báº¡n Ä‘á»ƒ lÃ m rÃµ ráº±ng dá»± Ã¡n Ä‘Ã³ khÃ´ng Ä‘Æ°á»£c xÃ¢y dá»±ng bá»Ÿi Ä‘á»™i ngÅ© GTAQCODE vÃ  khÃ´ng liÃªn káº¿t vá»›i chÃºng tÃ´i dÆ°á»›i báº¥t ká»³ hÃ¬nh thá»©c nÃ o.

---

**Tham gia cá»™ng Ä‘á»“ng cá»§a chÃºng tÃ´i** [Discord](https://discord.gg/GTAQCODE) | [X.com](https://x.com/GTAQCODE)
