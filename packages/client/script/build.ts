...
import { compile, emitEffectImported, emitPromise, write } from "@gtaqcode/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "GTAQCODEEventEncoded",
              import: 'import type { GTAQCODEEventEncoded } from "@gtaqcode/protocol/groups/event"',
            },
          },
        }),
