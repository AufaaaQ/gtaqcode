...
import compareVideo from "../../asset/lander/GTAQCODE-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/GTAQCODE-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="GTAQCODE:auth" content={loggedin() ? "true" : "false"} />
