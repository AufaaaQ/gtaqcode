...
import desktopAppIcon from "../../asset/lander/GTAQCODE-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://GTAQCODE.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>GTAQCODE.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g GTAQCODE-ai")}>
                <code>
                  npm i -g <strong>GTAQCODE-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g GTAQCODE-ai")}>
                <code>
                  bun add -g <strong>GTAQCODE-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/GTAQCODE")}>
                <code>
                  brew install <strong>anomalyco/tap/GTAQCODE</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S GTAQCODE")}>
                <code>
                  paru -S <strong>GTAQCODE</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask GTAQCODE-desktop")}>
                <code>
                  brew install --cask <strong>GTAQCODE-desktop</strong>
                </code>
                <CopyStatus />
              </button>
