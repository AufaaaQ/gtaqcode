...
import { IconGTAQCODE } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "GTAQCODE/session/message-v2"
import type { Message } from "GTAQCODE/session/message"
import type { Session } from "GTAQCODE/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.GTAQCODE_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.GTAQCODE_name}>
                    <IconGTAQCODE width={16} height={16} />
                  </div>
