...
const tools: readonly ToolFixture[] = [
  {
    icon: "âœ±",
    label:
      'Grep "GTAQCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/GTAQCODE/src (151 matches)',
  },
  {
    icon: "âœ±",
    label: 'Glob "**/*db*" in packages/GTAQCODE (6 matches)',
  },
  {
    icon: "â†’",
    label: "Read packages/GTAQCODE/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "â†’",
    label: "Read packages/GTAQCODE/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "âœ±",
    label:
      'Grep "export const GTAQCODE_DB|GTAQCODE_DB|GTAQCODE_DEV|Global\\.Path\\.data|data =" in packages/GTAQCODE/src (115 matches)',
  },
] as const
