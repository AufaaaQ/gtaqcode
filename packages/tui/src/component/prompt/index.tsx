...
import { registerGTAQCODESpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@gtaqcode/sdk/v2"
...
import { GTAQCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useGTAQCODEKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.GTAQCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
