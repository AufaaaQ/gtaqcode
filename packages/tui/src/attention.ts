...
import defaultSoundPath from "@gtaqcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@gtaqcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@gtaqcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@gtaqcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@gtaqcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@gtaqcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "GTAQCODE"
const DEFAULT_PACK_ID = "GTAQCODE.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "GTAQCODE Default",
  builtin: true,
  sounds: {
