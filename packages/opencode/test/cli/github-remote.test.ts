...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/GTAQCODE.git")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/GTAQCODE")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/GTAQCODE.git")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/GTAQCODE")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/GTAQCODE.git")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/GTAQCODE")).toEqual({ owner: "sst", repo: "GTAQCODE" })
})
