...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips GTAQCODE-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-GTAQCODE-directory"]).toBeUndefined()
      expect(forwarded["x-GTAQCODE-workspace"]).toBeUndefined()
