...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips GTAQCODE-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-GTAQCODE-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-GTAQCODE-directory")).toBeNull()
      expect(result.get("x-GTAQCODE-workspace")).toBeNull()
