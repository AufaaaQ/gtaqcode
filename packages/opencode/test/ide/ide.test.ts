...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders GTAQCODE_CALLER", () => {
    process.env["GTAQCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode GTAQCODE_CALLER", () => {
    process.env["GTAQCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown GTAQCODE_CALLER", () => {
    process.env["GTAQCODE_CALLER"] = "unknown"
