...
import { AccountStateTable, AccountTable } from "@gtaqcode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/AccountRepo") {}
