...
import type { AssistantMessage as GTAQCODEAssistantMessage, Message } from "@gtaqcode/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@gtaqcode/core/effect/app-node"
...
export type AssistantTokenCost = Pick<GTAQCODEAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<GTAQCODEAssistantMessage, "role"> &
  Partial<Pick<GTAQCODEAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@GTAQCODE/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@GTAQCODE/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/ACPUsage") {}
