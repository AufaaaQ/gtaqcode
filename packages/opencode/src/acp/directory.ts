...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@GTAQCODE/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/ACPDirectory") {}
