import type { Hooks, PluginInput } from "@gtaqcode/plugin"
import type { Model } from "@gtaqcode/sdk/v2"
import { InstallationVersion } from "@gtaqcode/core/installation/version"
import { OauthCallbackPage } from "@gtaqcode/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. GTAQCODE will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
