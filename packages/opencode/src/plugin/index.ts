...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "GTAQCODE-gitlab-auth"
import { PoeAuthPlugin } from "GTAQCODE-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Plugin") {}
