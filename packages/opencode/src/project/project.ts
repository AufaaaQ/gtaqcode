...
import { ProjectDirectoryTable, ProjectTable } from "@gtaqcode/core/project/sql"
import { ProjectDirectories } from "@gtaqcode/core/project/directories"
...
import { which } from "@gtaqcode/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.GTAQCODE_FAKE_VCS)
