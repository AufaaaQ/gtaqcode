...
>()("@GTAQCODE/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@GTAQCODE/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.GTAQCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.GTAQCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-GTAQCODE-directory"] || process.cwd()
}
