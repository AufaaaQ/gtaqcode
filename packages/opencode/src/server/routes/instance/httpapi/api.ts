...
import { makeApi } from "@gtaqcode/protocol/api"
import { LocationMiddleware } from "@gtaqcode/server/location"
import { SessionLocationMiddleware } from "@gtaqcode/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("GTAQCODE-root")
...
export const InstanceHttpApi = HttpApi.make("GTAQCODE-instance")
...
export const GTAQCODEHttpApi = HttpApi.make("GTAQCODE")
