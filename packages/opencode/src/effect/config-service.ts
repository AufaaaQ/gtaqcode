 ...
 *   "@GTAQCODE/ServerAuthConfig",
 *   {
 *     password: Config.string("GTAQCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("GTAQCODE_SERVER_USERNAME").pipe(Config.withDefault("GTAQCODE")),
 *   },
 * ) {}
 *
