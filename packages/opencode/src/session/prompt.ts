...
import { MAX_STEPS_PROMPT } from "@gtaqcode/core/session/runner/max-steps"
...
import { LLMEvent } from "@gtaqcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/SessionPrompt") {}
