import type { JsonSchema, LLMRequest, ProviderMetadata } from "@gtaqcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@gtaqcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @gtaqcode/llm request objects from GTAQCODE's session/AI SDK-shaped data.
  return LLM.request({
