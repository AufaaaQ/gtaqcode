import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@gtaqcode/llm"
...
// Move this extraction into @gtaqcode/llm when Copilot is handled by the native runtime.
