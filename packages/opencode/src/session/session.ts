...
import { locationServiceMapLayer } from "@gtaqcode/core/location-services"
...
import { PartTable, SessionTable } from "@gtaqcode/core/session/sql"
...
import { NonNegativeInt, optional } from "@gtaqcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".GTAQCODE", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Session") {}
