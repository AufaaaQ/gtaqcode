...
//
// The saved variant persists across sessions in ~/.local/state/GTAQCODE/model.json
...
class Service extends Context.Service<Service, VariantService>()("@GTAQCODE/RunVariant") {}
