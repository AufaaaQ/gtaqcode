...
import { registerGTAQCODESpinner } from "@gtaqcode/tui/component/register-spinner"
import { createColors, createFrames } from "@gtaqcode/tui/ui/spinner"
import {
...
export function RunFooterView(props: RunFooterViewProps) {
  ...
  const sectionSeparator = () => <span style={{ fg: theme().muted }}>Â· </span>
