...
import { normalizePromptContent } from "@gtaqcode/tui/editor"
...
import { GTAQCODE_BASE_MODE, useBindings } from "@gtaqcode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close GTAQCODE" } satisfies SlashOption,
    ]
