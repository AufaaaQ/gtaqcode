...
import { openEditor } from "@gtaqcode/tui/editor"
import { registerGTAQCODEKeymap } from "@gtaqcode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerGTAQCODEKeymap(keymap, renderer, input.tuiConfig)
