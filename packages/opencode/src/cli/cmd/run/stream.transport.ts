...
import type { Event, GlobalEvent, GTAQCODEClient } from "@gtaqcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@GTAQCODE/RunStreamTransport") {}
