...
import type * as SDK from "@gtaqcode/sdk/v2"
...
import { SessionShareTable } from "@gtaqcode/core/share/sql"
...
const disabled = process.env["GTAQCODE_DISABLE_SHARE"] === "true" || process.env["GTAQCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/ShareNext") {}
