...
import { AbsolutePath, type DeepMutable } from "@gtaqcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".GTAQCODE", "plans", "*.md")]: "allow",
