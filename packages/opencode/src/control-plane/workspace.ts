...
import { EventSequenceTable, EventTable } from "@gtaqcode/core/event/sql"
...
import { WorkspaceEvent } from "@gtaqcode/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        GTAQCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        GTAQCODE_WORKSPACE_ID: config.id,
        GTAQCODE_EXPERIMENTAL_WORKSPACES: "true",
