...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __GTAQCODE_PHOTON_WASM_PATH?: string }).__GTAQCODE_PHOTON_WASM_PATH =
