...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/GTAQCODE`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy GTAQCODE service removed
