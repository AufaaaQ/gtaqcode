...
export const dict: Record<Keys, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonner p̴ GTAQCODE Go for p̴litelig tilgang til de beste ̴pen kildekode-modellene, fra $5/m̴ned.",
  ...
  "ui.sessionReviewV2.empty.noGit.description": "Spor, gjennomg̴ og angre endringer i dette prosjektet",
  ...
  "ui.sessionReviewV2.empty.changes.title": "Ingen filendringer enn̴",
