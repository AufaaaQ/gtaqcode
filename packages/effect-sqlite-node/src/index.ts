...
export const TypeId: TypeId = "~@gtaqcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@gtaqcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@gtaqcode/effect-sqlite-node/NodeSqliteClient")
