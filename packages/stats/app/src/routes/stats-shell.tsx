import GTAQCODEWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/anomalyco/GTAQCODE",
  apiHref: "https://api.github.com/repos/anomalyco/GTAQCODE",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "GTAQCODE:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://GTAQCODE.ai/">
            <strong>{i18n.t("header.tryGTAQCODE")}</strong>
          </a>
          <button
...
function GTAQCODEMark() {
  return (
    <svg data-slot="GTAQCODE-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://GTAQCODE.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://GTAQCODE.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@GTAQCODE.ai", label: i18n.t("footer.contact") },
    { href: "https://GTAQCODE.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/GTAQCODE", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://GTAQCODE.ai" aria-label={i18n.t("footer.homeAria")}>
          <GTAQCODEMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={GTAQCODEWordmarkDark} alt="GTAQCODE" />
          <button
