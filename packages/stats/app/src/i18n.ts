...
const en = {
  "app.title": "AI Model Usage Rankings | GTAQCODE Data",
  "app.description":
    "Explore GTAQCODE Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "GTAQCODE Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star GTAQCODE on GitHub",
  "header.github": "GitHub",
  "header.tryGTAQCODE": "Try GTAQCODE",
  ...
  "home.topModelsDescription": "Usage of models across GTAQCODE Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique GTAQCODE Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | GTAQCODE Data",
  "lab.description":
    "Compare {{lab}} models used in GTAQCODE Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent GTAQCODE usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in GTAQCODE",
  ...
  "lab.shareOfUsage": "{{share}} of recent GTAQCODE usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | GTAQCODE Data",
  "model.description":
    "View {{model}} GTAQCODE Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. GTAQCODE Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's GTAQCODE Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's GTAQCODE Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No GTAQCODE Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no GTAQCODE Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "GTAQCODE Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No GTAQCODE Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent GTAQCODE Go token volume.",
