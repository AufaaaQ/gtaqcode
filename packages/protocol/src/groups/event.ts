...
import type { Definition } from "@gtaqcode/schema/event"
...
export const GTAQCODEEvent = event.schema
export type GTAQCODEEvent = typeof GTAQCODEEvent.Type
export type GTAQCODEEventEncoded = typeof GTAQCODEEvent.Encoded
