...
class Database extends Context.Service<Database, DatabaseShape>()("@GTAQCODE/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@GTAQCODE/example/UserStore") {
