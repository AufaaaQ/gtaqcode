...
export const dict = {
  ...
  "command.project.next": "NÃ¤chstes Projekt",
  ...
  "command.tab.reopenClosed": "Geschlossenen Tab wieder Ã¶ffnen",
  ...
  "dialog.provider.GTAQCODE.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.GTAQCODE.tagline": "ZuverlÃ¤ssige, optimierte Modelle",
  "dialog.provider.GTAQCODEGo.tagline": "KostengÃ¼nstiges Abo fÃ¼r alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von GTAQCODE",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-SchlÃ¼ssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GTAQCODE zu nutzen.",
  ...
  "provider.connect.GTAQCODEZen.line1":
    "GTAQCODE Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlÃ¤ssiger, optimierter Modelle fÃ¼r Coding-Agenten.",
  "provider.connect.GTAQCODEZen.line2":
    "Mit einem einzigen API-SchlÃ¼ssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.GTAQCODEZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.GTAQCODEZen.visit.link": "GTAQCODE.ai/zen",
  "provider.connect.GTAQCODEZen.visit.suffix": ", um Ihren API-SchlÃ¼ssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in GTAQCODE zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GTAQCODE zu nutzen.",
  ...
  "session.child.promptDisabled": "Unteragenten-Sitzungen kÃ¶nnen keine Prompts erhalten.",
  "session.child.backToParent": "ZurÃ¼ck zur Hauptsitzung.",
  ...
  "prompt.menu.addImagesAndFiles": "Dateien und mehr hinzufÃ¼gen",
  ...
  "dialog.plugins.empty": "In GTAQCODE.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den GTAQCODE-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.server.add": "WSL-Server hinzufÃ¼gen",
  "wsl.server.addShort": "WSL hinzufÃ¼gen",
  ...
  "wsl.onboarding.step.distro": "Distribution auswÃ¤hlen",
  "wsl.onboarding.step.GTAQCODE": "GTAQCODE",
  "wsl.onboarding.checkingRuntime": "WSL wird geprÃ¼ft...",
  "wsl.onboarding.restartRequired": "Windows muss neu gestartet werden, um die WSL-Installation abzuschlieÃŸen.",
  "wsl.onboarding.ready": "WSL ist bereit.",
  "wsl.onboarding.required": "WSL ist erforderlich, um fortzufahren.",
  "wsl.onboarding.checkingDistros": "Distributionen werden geprÃ¼ft...",
  "wsl.onboarding.installingDistro": "{{distro}} wird installiert...",
  "wsl.onboarding.checkingDistro": "{{distro}} wird geprÃ¼ft...",
  ...
  "wsl.onboarding.openDistroOnce": "Ã–ffnen Sie {{distro}} einmal, um die Einrichtung abzuschlieÃŸen.",
  "wsl.onboarding.finishingDistro": "Einrichtung von {{distro}} wird abgeschlossen.",
  "wsl.onboarding.pickDistro": "WÃ¤hlen Sie eine Distribution aus oder installieren Sie unten eine.",
  "wsl.onboarding.checkingGTAQCODE": "GTAQCODE wird geprÃ¼ft...",
  "wsl.onboarding.checkingGTAQCODEIn": "GTAQCODE in {{distro}} wird geprÃ¼ft...",
  "wsl.onboarding.updatingGTAQCODE": "GTAQCODE wird aktualisiert...",
  "wsl.onboarding.updatingGTAQCODEIn": "GTAQCODE in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateGTAQCODEIn": "Aktualisieren Sie GTAQCODE in {{distro}}.",
  "wsl.onboarding.updateGTAQCODE": "GTAQCODE aktualisieren",
  "wsl.onboarding.GTAQCODEReadyIn": "GTAQCODE ist in {{distro}} bereit.",
  "wsl.onboarding.GTAQCODEReady": "GTAQCODE ist bereit.",
  "wsl.onboarding.installGTAQCODEIn": "Installieren Sie GTAQCODE in {{distro}}.",
  "wsl.onboarding.installGTAQCODE": "GTAQCODE installieren",
  "wsl.onboarding.chooseDistroFirst": "WÃ¤hlen Sie zuerst eine Distribution aus.",
  ...
  "wsl.onboarding.checkAgain": "Erneut prÃ¼fen",
  "wsl.onboarding.distroStatus.ready": "Bereit",
  "wsl.onboarding.distroStatus.checking": "Wird geprÃ¼ft...",
  "wsl.onboarding.distroStatus.GTAQCODEMissing": "GTAQCODE nicht installiert",
  "wsl.onboarding.distroStatus.missingTools": "Fehlend: bash, curl",
  "wsl.onboarding.distroStatus.unsupported": "Nicht unterstÃ¼tzt Â· WSL 2 verwenden",
  "wsl.onboarding.needAnotherDistro": "Andere Distribution benÃ¶tigt?",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor GTAQCODE einen WSL-Server hinzufÃ¼gen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfÃ¼gbar",
  "wsl.onboarding.wslUnavailable.description": "GTAQCODE konnte WSL auf diesem Computer nicht Ã¼berprÃ¼fen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschlieÃŸen, und Ã¶ffnen Sie dann GTAQCODE erneut.",
  "wsl.onboarding.next": "Weiter",
  "wsl.onboarding.refresh": "Aktualisieren",
  "wsl.onboarding.allDistrosAdded": "Alle installierten Distributionen wurden bereits hinzugefÃ¼gt.",
  ...
  "wsl.onboarding.toolsRequired": "Diese Distribution benÃ¶tigt bash und curl.",
  "wsl.onboarding.openTerminal": "Terminal Ã¶ffnen",
  ...
  "wsl.onboarding.adding": "Wird hinzugefÃ¼gt...",
  ...
  "toast.update.description": "Eine neue Version von GTAQCODE ({{version}}) ist zur Installation verfÃ¼gbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem GTAQCODE-Team",
  ...
  "error.chain.checkConfig": "ÃœberprÃ¼fen Sie Ihre Konfiguration (GTAQCODE.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: GTAQCODE unterstÃ¼tzt noch keine MCP-Authentifizierung.',
  ...
  "home.project.add": "Projekt hinzufÃ¼gen",
  "home.recentlyClosed": "KÃ¼rzlich geschlossen",
  ...
  "home.sessions.search.noResults": "Keine Sitzungen fÃ¼r {{query}} gefunden",
  ...
  "home.sessions.group.older": "Ã„lter",
  "home.providerTip":
    "Verbinde dich mit Ã¼ber 75 Anbietern, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "session.error.notFound.closeTab": "Tab schlieÃŸen",
  "session.error.serverConnection": "Verbindung zu diesem Server nicht mÃ¶glich",
  ...
  "session.review.noUncommittedChanges": "Noch keine nicht committeten Ã„nderungen",
  "session.review.noBranchChanges": "Noch keine Branch-Ã„nderungen",
  ...
  "session.new.project.add": "Projekt hinzufÃ¼gen",
  ...
  "session.new.workspace.runIn": "Sitzung ausfÃ¼hren in",
  "session.new.workspace.triggerLocal": "Lokal",
  "session.new.workspace.local": "Lokales Repository",
  "session.new.workspace.existing": "Arbeitsbereichâ€¦",
  ...
  "sidebar.gettingStarted.line1": "GTAQCODE enthÃ¤lt kostenlose Modelle, damit Sie sofort loslegen kÃ¶nnen.",
  ...
  "sidebar.empty.title": "Keine Projekte geÃ¶ffnet",
  "sidebar.empty.description": "Ã–ffnen Sie ein Projekt, um loszulegen",
  "app.name.desktop": "GTAQCODE Desktop",
  ...
  "settings.desktop.wsl.description": "GTAQCODE-Server innerhalb von WSL unter Windows ausfÃ¼hren.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache fÃ¼r GTAQCODE Ã¤ndern",
  "settings.general.row.shell.title": "Terminal-Shell",
  "settings.general.row.shell.description":
    "WÃ¤hlen Sie die Shell fÃ¼r Ihr Terminal aus. Kompatible Shells werden auch fÃ¼r Tool-Aufrufe von Agenten verwendet.",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie GTAQCODE auf Ihrem GerÃ¤t aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "WÃ¤hlen Sie, ob GTAQCODE dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von GTAQCODE anpassen.",
  ...
  "settings.general.row.showNavigation.description":
    "SchaltflÃ¤chen zum Vor- und ZurÃ¼cknavigieren in der Desktop-Titelleiste anzeigen",
  "settings.general.row.showSearch.title": "Befehlspalette",
  "settings.general.row.showSearch.description":
    "SchaltflÃ¤che fÃ¼r Suche und Befehlspalette in der Titelleiste anzeigen",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Terminal-SchaltflÃ¤che in der Desktop-Titelleiste anzeigen",
  "settings.general.row.showStatus.title": "Serverstatus",
  "settings.general.row.showStatus.description": "Serverstatus-SchaltflÃ¤che in der Titelleiste anzeigen",
  "settings.general.row.mobileTitlebarBottom.title": "Navigation unten",
  "settings.general.row.mobileTitlebarBottom.description":
    "Titelleiste und Sitzungs-Tabs auf MobilgerÃ¤ten am unteren Bildschirmrand platzieren",
  ...
  "settings.general.row.newLayoutDesigns.description":
    "Neu gestaltetes Layout, Startseite, Eingabebereich und SitzungsoberflÃ¤che aktivieren",
  ...
  "settings.updates.row.startup.description": "Beim Start von GTAQCODE automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von GTAQCODE.",
