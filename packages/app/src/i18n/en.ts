export const dict = {
  ...
  "dialog.provider.GTAQCODE.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.GTAQCODE.tagline": "Reliable optimized models",
  "dialog.provider.GTAQCODEGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by GTAQCODE",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in GTAQCODE.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.GTAQCODEZen.line1":
    "GTAQCODE Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.GTAQCODEZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.GTAQCODEZen.visit.prefix": "Visit ",
  "provider.connect.GTAQCODEZen.visit.link": "GTAQCODE.ai/zen",
  "provider.connect.GTAQCODEZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in GTAQCODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in GTAQCODE.",
  ...
  "dialog.plugins.empty": "Plugins configured in GTAQCODE.json",
  ...
  "dialog.server.description": "Switch which GTAQCODE server this app connects to.",
  ...
  "wsl.onboarding.checkingGTAQCODE": "Checking GTAQCODE...",
  "wsl.onboarding.checkingGTAQCODEIn": "Checking GTAQCODE in {{distro}}...",
  "wsl.onboarding.updatingGTAQCODE": "Updating GTAQCODE...",
  "wsl.onboarding.updatingGTAQCODEIn": "Updating GTAQCODE in {{distro}}...",
  "wsl.onboarding.updateGTAQCODEIn": "Update GTAQCODE in {{distro}}.",
  "wsl.onboarding.updateGTAQCODE": "Update GTAQCODE",
  "wsl.onboarding.GTAQCODEReadyIn": "GTAQCODE is ready in {{distro}}.",
  "wsl.onboarding.GTAQCODEReady": "GTAQCODE is ready.",
  "wsl.onboarding.installGTAQCODEIn": "Install GTAQCODE in {{distro}}.",
  "wsl.onboarding.installGTAQCODE": "Install GTAQCODE",
  ...
  "wsl.onboarding.distroStatus.GTAQCODEMissing": "GTAQCODE not installed",
  "wsl.onboarding.distroStatus.missingTools": "Missing bash, curl",
  "wsl.onboarding.distroStatus.unsupported": "Unsupported Â· Use WSL 2",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before GTAQCODE can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "GTAQCODE could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen GTAQCODE.",
  ...
  "toast.update.description": "A new version of GTAQCODE ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the GTAQCODE team",
  ...
  "error.chain.checkConfig": "Check your config (GTAQCODE.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GTAQCODE does not support MCP authentication yet.',
  ...
  "session.new.workspace.existing": "Workspaceâ€¦",
  ...
  "sidebar.gettingStarted.line1": "GTAQCODE includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the GTAQCODE server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for GTAQCODE",
  ...
  "settings.general.row.appearance.description": "Customise how GTAQCODE looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether GTAQCODE follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how GTAQCODE is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when GTAQCODE launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of GTAQCODE.",
