export const dict = {
  ...
  "dialog.provider.GTAQCODE.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.GTAQCODE.tagline": "PÃ¥lidelige optimerede modeller",
  "dialog.provider.GTAQCODEGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af GTAQCODE",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nÃ¸gle for at forbinde din konto og bruge {{provider}} modeller i GTAQCODE.",
  ...
  "provider.connect.GTAQCODEZen.line1":
    "GTAQCODE Zen giver dig adgang til et udvalg af pÃ¥lidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.GTAQCODEZen.visit.prefix": "BesÃ¸g ",
  "provider.connect.GTAQCODEZen.visit.link": "GTAQCODE.ai/zen",
  "provider.connect.GTAQCODEZen.visit.suffix": " for at hente din API-nÃ¸gle.",
  "provider.connect.oauth.code.visit.prefix": "BesÃ¸g ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i GTAQCODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i GTAQCODE.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i GTAQCODE.json",
  ...
  "dialog.server.description": "Skift hvilken GTAQCODE-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingGTAQCODE": "Tjekker GTAQCODE...",
  "wsl.onboarding.checkingGTAQCODEIn": "Tjekker GTAQCODE i {{distro}}...",
  "wsl.onboarding.updatingGTAQCODE": "Opdaterer GTAQCODE...",
  "wsl.onboarding.updatingGTAQCODEIn": "Opdaterer GTAQCODE i {{distro}}...",
  "wsl.onboarding.updateGTAQCODEIn": "Opdater GTAQCODE i {{distro}}.",
  "wsl.onboarding.updateGTAQCODE": "Opdater GTAQCODE",
  ...
  "wsl.onboarding.distroStatus.GTAQCODEMissing": "GTAQCODE er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er pÃ¥krÃ¦vet, fÃ¸r GTAQCODE kan tilfÃ¸je en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgÃ¦ngelig",
  "wsl.onboarding.wslUnavailable.description": "GTAQCODE kunne ikke bekrÃ¦fte WSL pÃ¥ denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldfÃ¸re installationen af WSL, og Ã¥bn derefter GTAQCODE igen.",
  ...
  "toast.update.description": "En ny version af GTAQCODE ({{version}}) er nu tilgÃ¦ngelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til GTAQCODE-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (GTAQCODE.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. BemÃ¦rk, GTAQCODE understÃ¸tter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "GTAQCODE inkluderer gratis modeller sÃ¥ du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "KÃ¸r GTAQCODE-serveren inde i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Ã†ndr visningssproget for GTAQCODE",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan GTAQCODE ser ud pÃ¥ din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "VÃ¦lg om GTAQCODE fÃ¸lger systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan GTAQCODE er temabestemt.",
  ...
  "settings.general.row.newLayoutDesigns.description":
    "AktivÃ©r det nydesignede layout, startsiden, promptfeltet og sessionsbrugerfladen",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, nÃ¥r GTAQCODE starter",
  ...
  "settings.updates.toast.latest.description": "Du kÃ¸rer den nyeste version af GTAQCODE.",
