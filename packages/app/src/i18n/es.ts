export const dict = {
  ...
  "dialog.provider.GTAQCODE.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y mÃ¡s",
  "dialog.provider.GTAQCODE.tagline": "Modelos optimizados y fiables",
  "dialog.provider.GTAQCODEGo.tagline": "SuscripciÃ³n econÃ³mica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por GTAQCODE",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en GTAQCODE.",
  ...
  "provider.connect.GTAQCODEZen.line1":
    "GTAQCODE Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programaciÃ³n.",
  "provider.connect.GTAQCODEZen.line2":
    "Con una sola clave API obtendrÃ¡s acceso a modelos como Claude, GPT, Gemini, GLM y mÃ¡s.",
  "provider.connect.GTAQCODEZen.visit.prefix": "Visita ",
  "provider.connect.GTAQCODEZen.visit.link": "GTAQCODE.ai/zen",
  "provider.connect.GTAQCODEZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu cÃ³digo de autorizaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en GTAQCODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el cÃ³digo a continuaciÃ³n para conectar tu cuenta y usar modelos de {{provider}} en GTAQCODE.",
  ...
  "dialog.plugins.empty": "Plugins configurados en GTAQCODE.json",
  ...
  "dialog.server.description": "Cambiar a quÃ© servidor de GTAQCODE se conecta esta app.",
  ...
  "wsl.onboarding.checkingGTAQCODE": "Comprobando GTAQCODE...",
  "wsl.onboarding.checkingGTAQCODEIn": "Comprobando GTAQCODE en {{distro}}...",
  "wsl.onboarding.updatingGTAQCODE": "Actualizando GTAQCODE...",
  "wsl.onboarding.updatingGTAQCODEIn": "Actualizando GTAQCODE en {{distro}}...",
  "wsl.onboarding.updateGTAQCODEIn": "Actualiza GTAQCODE en {{distro}}.",
  "wsl.onboarding.updateGTAQCODE": "Actualizar GTAQCODE",
  "wsl.onboarding.GTAQCODEReadyIn": "GTAQCODE estÃ¡ listo en {{distro}}.",
  "wsl.onboarding.GTAQCODEReady": "GTAQCODE estÃ¡ listo.",
  "wsl.onboarding.installGTAQCODEIn": "Instala GTAQCODE en {{distro}}.",
  "wsl.onboarding.installGTAQCODE": "Instalar GTAQCODE",
  ...
  "wsl.onboarding.distroStatus.GTAQCODEMissing": "GTAQCODE no estÃ¡ instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que GTAQCODE pueda aÃ±adir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "GTAQCODE no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, despuÃ©s, vuelve a abrir GTAQCODE.",
  ...
  "toast.update.description": "Una nueva versiÃ³n de GTAQCODE ({{version}}) estÃ¡ disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de GTAQCODE",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuraciÃ³n (GTAQCODE.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" fallÃ³. Nota, GTAQCODE no soporta autenticaciÃ³n MCP todavÃ­a.',
  ...
  "sidebar.gettingStarted.line1": "GTAQCODE incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor GTAQCODE dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualizaciÃ³n para GTAQCODE",
  ...
  "settings.general.row.appearance.description": "Personaliza cÃ³mo se ve GTAQCODE en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si GTAQCODE sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de GTAQCODE.",
  ...
  "settings.general.row.newLayoutDesigns.title": "Nuevo diseÃ±o y estilos",
  "settings.general.row.newLayoutDesigns.description":
    "Activar el nuevo diseÃ±o de la interfaz, la pÃ¡gina de inicio, el editor y las sesiones",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automÃ¡ticamente cuando se inicia GTAQCODE",
  ...
  "settings.updates.toast.latest.description": "EstÃ¡s usando la Ãºltima versiÃ³n de GTAQCODE.",
