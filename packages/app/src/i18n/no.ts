...
export const dict = {
  ...
  "command.workspace.toggle.description": "Aktiver eller deaktiver flere arbeidsomrÃ¥der i sidefeltet",
  ...
  "dialog.provider.GTAQCODE.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.GTAQCODE.tagline": "PÃ¥litelige, optimaliserte modeller",
  "dialog.provider.GTAQCODEGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av GTAQCODE",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i GTAQCODE.",
  ...
  "provider.connect.GTAQCODEZen.line1":
    "GTAQCODE Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.GTAQCODEZen.visit.prefix": "BesÃ¸k ",
  "provider.connect.GTAQCODEZen.visit.link": "GTAQCODE.ai/zen",
  "provider.connect.GTAQCODEZen.visit.suffix": " for Ã¥ hente API-nÃ¸kkelen din.",
  "provider.connect.oauth.code.visit.prefix": "BesÃ¸k ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i GTAQCODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i GTAQCODE.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i GTAQCODE.json",
  ...
  "dialog.server.description": "Bytt hvilken GTAQCODE-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av GTAQCODE ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til GTAQCODE-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (GTAQCODE.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GTAQCODE ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  ...
  "sidebar.gettingStarted.line1": "GTAQCODE inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r GTAQCODE-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for GTAQCODE",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan GTAQCODE ser ut pÃ¥ enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om GTAQCODE skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan GTAQCODE er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r GTAQCODE starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av GTAQCODE.",
  ...
  "command.tab.reopenClosed": "Ã…pne lukket fane pÃ¥ nytt",

  "model.tooltip.context.label": "Kontekst",
  "model.tooltip.inputs": "Inndata",
  "model.tooltip.model": "Modell",
  "model.tooltip.provider": "LeverandÃ¸r",
  "model.tooltip.reasoning": "Resonnering",

  "common.clear": "TÃ¸m",

  "session.child.promptDisabled": "Underagentsesjoner kan ikke motta forespÃ¸rsler.",
  ...
  "wsl.server.retryStart": "PrÃ¸v Ã¥ starte pÃ¥ nytt",
  ...
  "wsl.onboarding.restartRequired": "Windows mÃ¥ startes pÃ¥ nytt for Ã¥ fullfÃ¸re installasjonen av WSL.",
  "wsl.onboarding.ready": "WSL er klart.",
  "wsl.onboarding.required": "WSL kreves for Ã¥ fortsette.",
  ...
  "wsl.onboarding.distroNotInstalled": "{{distro}} er ikke installert ennÃ¥.",
  "wsl.onboarding.openDistroOnce": "Ã…pne {{distro}} Ã©n gang for Ã¥ fullfÃ¸re oppsettet.",
  "wsl.onboarding.finishingDistro": "FullfÃ¸rer oppsettet for {{distro}}.",
  "wsl.onboarding.pickDistro": "Velg en distribusjon eller installer en nedenfor.",
  "wsl.onboarding.checkingGTAQCODE": "Sjekker GTAQCODE...",
  "wsl.onboarding.checkingGTAQCODEIn": "Sjekker GTAQCODE i {{distro}}...",
  "wsl.onboarding.updatingGTAQCODE": "Oppdaterer GTAQCODE...",
  "wsl.onboarding.updatingGTAQCODEIn": "Oppdaterer GTAQCODE i {{distro}}...",
  "wsl.onboarding.updateGTAQCODEIn": "Oppdater GTAQCODE i {{distro}}.",
  "wsl.onboarding.updateGTAQCODE": "Oppdater GTAQCODE",
  "wsl.onboarding.GTAQCODEReadyIn": "GTAQCODE er klar i {{distro}}.",
  "wsl.onboarding.GTAQCODEReady": "GTAQCODE er klar.",
  "wsl.onboarding.installGTAQCODEIn": "Installer GTAQCODE i {{distro}}.",
  "wsl.onboarding.installGTAQCODE": "Installer GTAQCODE",
  "wsl.onboarding.chooseDistroFirst": "Velg en distribusjon fÃ¸rst.",
  ...
  "wsl.onboarding.checkAgain": "Sjekk pÃ¥ nytt",
  "wsl.onboarding.distroStatus.ready": "Klar",
  "wsl.onboarding.distroStatus.checking": "Sjekker...",
  "wsl.onboarding.distroStatus.GTAQCODEMissing": "GTAQCODE er ikke installert",
  "wsl.onboarding.distroStatus.missingTools": "Mangler bash, curl",
  "wsl.onboarding.distroStatus.unsupported": "Ikke stÃ¸ttet Â· Bruk WSL 2",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves fÃ¸r GTAQCODE kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "GTAQCODE kunne ikke bekrefte WSL pÃ¥ denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows pÃ¥ nytt for Ã¥ fullfÃ¸re installasjonen av WSL, og Ã¥pne deretter GTAQCODE pÃ¥ nytt.",
  ...
  "wsl.onboarding.noDistros": "Ingen distribusjoner oppdaget ennÃ¥.",
  "wsl.onboarding.install": "Installer",
  "wsl.onboarding.installing": "Installerer...",
  "wsl.onboarding.installDistro": "Installer distribusjon",
  "wsl.onboarding.searchDistros": "SÃ¸k etter distribusjoner",
  "wsl.onboarding.wsl2Required": "WSL 2 er pÃ¥krevd.",
  "wsl.onboarding.toolsRequired": "Denne distribusjonen trenger bash og curl.",
  "wsl.onboarding.openTerminal": "Ã…pne terminal",
  ...
  "home.sessions.search.placeholder": "SÃ¸k etter sesjoner",
  "home.sessions.search.placeholder.scoped": "SÃ¸k etter sesjoner i {{scope}}",
  "home.sessions.search.sessions": "Sesjoner",
  "home.sessions.search.noResults": "Ingen sesjoner funnet for {{query}}",
  "home.sessions.empty": "Ingenting her ennÃ¥",
  "home.sessions.empty.description": "Opprett en sesjon for Ã¥ komme i gang",
  "home.sessions.group.today": "I dag",
  "home.sessions.group.yesterday": "I gÃ¥r",
  "home.sessions.group.older": "Eldre",
  "home.providerTip":
    "Koble til over 75 leverandÃ¸rer for Ã¥ bruke andre modeller, inkludert Claude, GPT, Gemini og flere",

  "session.tab.unknown": "Ukjent sesjon",
  "session.error.notFound": "Denne sesjonen finnes ikke",
  "session.error.notFound.description": "Denne fanen peker til en sesjon som ikke lenger finnes pÃ¥ denne serveren.",
  "session.error.notFound.closeTab": "Lukk fane",
  "session.error.serverConnection": "Kan ikke koble til denne serveren",
  "session.review.noUncommittedChanges": "Ingen ucommittede endringer ennÃ¥",
  "session.review.noBranchChanges": "Ingen grenendringer ennÃ¥",
  "session.question.minimize": "Minimer spÃ¸rsmÃ¥l",
  "session.question.restore": "Gjenopprett spÃ¸rsmÃ¥l",
  "session.question.pending.one": "{{count}} ventende spÃ¸rsmÃ¥l",
  "session.question.pending.other": "{{count}} ventende spÃ¸rsmÃ¥l",
  "session.new.project.new": "Nytt prosjekt",
  "session.new.project.search": "SÃ¸k etter prosjekter",
  "session.new.project.add": "Legg til prosjekt",
  "session.new.workspace.runIn": "KjÃ¸r sesjonen i",
  "session.new.workspace.triggerLocal": "Lokalt",
  "session.new.workspace.local": "Lokalt depot",
  "session.new.workspace.existing": "ArbeidsomrÃ¥deâ€¦",

  "sidebar.empty.title": "Ingen Ã¥pne prosjekter",
  "sidebar.empty.description": "Ã…pne et prosjekt for Ã¥ komme i gang",

  "settings.general.section.advanced": "Avansert",
  "settings.general.row.shell.title": "Terminalskall",
  "settings.general.row.shell.description":
    "Velg skallet som skal brukes i terminalen. Kompatible skall brukes ogsÃ¥ til agentens verktÃ¸ykall.",
  ...
  "settings.general.row.showNavigation.description":
    "Vis tilbake- og fremoverknappene pÃ¥ tittellinjen i skrivebordsappen",
  "settings.general.row.showSearch.title": "Kommandopalett",
  "settings.general.row.showSearch.description": "Vis knappen for sÃ¸k og kommandopalett pÃ¥ tittellinjen",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Vis terminalknappen pÃ¥ tittellinjen i skrivebordsappen",
  "settings.general.row.showStatus.title": "Serverstatus",
  "settings.general.row.showStatus.description": "Vis serverstatusknappen pÃ¥ tittellinjen",
  "settings.general.row.mobileTitlebarBottom.title": "Navigasjon nederst",
  "settings.general.row.mobileTitlebarBottom.description":
    "Plasser tittellinjen og sesjonsfanene nederst pÃ¥ mobilskjermen",
  ...
  "settings.general.row.pinchZoom.title": "Knip for Ã¥ zoome",
  "settings.general.row.pinchZoom.description": "Tillat knipebevegelser pÃ¥ styreflaten og Ctrl-rulling for Ã¥ zoome",
