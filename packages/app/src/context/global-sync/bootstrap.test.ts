...
import type { Config, GTAQCODEClient, Project, Session } from "@gtaqcode/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@gtaqcode/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as GTAQCODEClient
