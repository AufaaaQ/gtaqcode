...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: GTAQCODEClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: GTAQCODEClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: GTAQCODEClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => GTAQCODEClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, GTAQCODEClient>()
