  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://GTAQCODE.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://GTAQCODE.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://GTAQCODE.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://GTAQCODE.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://GTAQCODE.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://GTAQCODE.example.com"),
      ),
    ).toEqual({
