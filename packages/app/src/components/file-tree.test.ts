...
beforeAll(async () => {
  ...
  mock.module("@gtaqcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@gtaqcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@gtaqcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@gtaqcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
