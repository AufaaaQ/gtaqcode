...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "GTAQCODE", key: "dialog.provider.GTAQCODE.note" },
  { match: (id: string) => id === "GTAQCODE-go", key: "dialog.provider.GTAQCODEGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "GTAQCODE" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "GTAQCODE" || item.id === "GTAQCODE-go"}>
