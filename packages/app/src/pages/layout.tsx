...
import { Session } from "@gtaqcode/sdk/v2/client"
...
import { toaster } from "@gtaqcode/ui/toast"
...
import { useTheme, type ColorScheme } from "@gtaqcode/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://GTAQCODE.ai/desktop-feedback")}
      renderPanel={() =>
