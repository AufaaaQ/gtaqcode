...
const GLOBAL_STORAGE = "GTAQCODE.global.dat"
const WINDOW_STORAGE = "GTAQCODE.window"
const LOCAL_PREFIX = "GTAQCODE."
...
function workspaceStorage(dir: string) {
  ...
  return `GTAQCODE.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `GTAQCODE.draft.${head}.${sum}.dat`
}
