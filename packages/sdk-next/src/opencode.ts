import { GTAQCODE } from "@gtaqcode/client/effect"
...
import { createEmbeddedRoutes } from "@gtaqcode/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("GTAQCODE.create")(function* () {
  ...
  const client = yield* GTAQCODE.make({ baseUrl: "http://GTAQCODE.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@gtaqcode/sdk-next/GTAQCODE") {}
