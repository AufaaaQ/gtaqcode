...
declare const GTAQCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof GTAQCODE_CLI_NAME === "string" ? GTAQCODE_CLI_NAME : "GTAQCODE", {
  description: "GTAQCODE 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
