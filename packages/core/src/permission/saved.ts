...
import { PermissionSaved } from "@gtaqcode/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/PermissionSaved") {}
