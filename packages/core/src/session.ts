...
import { ListAnchor } from "@gtaqcode/schema/session"
...
import { SessionDurable } from "@gtaqcode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/Session") {}
