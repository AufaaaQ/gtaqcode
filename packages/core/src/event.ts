...
import type { Data, Definition, Payload } from "@gtaqcode/schema/event"
...
import { Durable } from "@gtaqcode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@gtaqcode/schema/event").ID
export type { Data, Definition, Payload } from "@gtaqcode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/Event") {}
