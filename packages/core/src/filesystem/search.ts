...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.GTAQCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
