...
import { FileSystemWatcher } from "@gtaqcode/schema/filesystem-watcher"
...
declare const GTAQCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof GTAQCODE_LIBC === "undefined" ? undefined : GTAQCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.GTAQCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.GTAQCODE_EXPERIMENTAL_FILEWATCHER)) {
