...
import { Event } from "@gtaqcode/schema/project-directories"
import { ProjectCopy } from "@gtaqcode/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/ProjectCopy") {}
