...
import type { EffectDrizzleSqlite } from "@gtaqcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/ProjectDirectories") {}
