...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@gtaqcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/ToolRegistry") {}
