...
import { Entry, FileSystem, FindInput, Match } from "@gtaqcode/schema/filesystem"
export { Entry, Match, Submatch } from "@gtaqcode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@GTAQCODE/v2/FileSystem") {}
