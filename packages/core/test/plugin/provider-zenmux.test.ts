...
import { ProviderPlugins } from "@gtaqcode/core/plugin/provider"
import { ZenmuxPlugin } from "@gtaqcode/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://GTAQCODE.ai/", "X-Title": "GTAQCODE" })
