...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@gtaqcode/schema/prompt"
import { Provider } from "@gtaqcode/schema/provider"
import { Project } from "@gtaqcode/schema/project"
import { ProjectDirectories } from "@gtaqcode/schema/project-directories"
import { PermissionV1 } from "@gtaqcode/schema/permission-v1"
...
import { Command } from "@gtaqcode/schema/command"
import { Connection } from "@gtaqcode/schema/connection"
import { Credential } from "@gtaqcode/schema/credential"
import { FileSystem } from "@gtaqcode/schema/filesystem"
import { Integration } from "@gtaqcode/schema/integration"
import { LLM } from "@gtaqcode/schema/llm"
import { Permission } from "@gtaqcode/schema/permission"
import { Plugin } from "@gtaqcode/schema/plugin"
import { Pty } from "@gtaqcode/schema/pty"
import { Reference } from "@gtaqcode/schema/reference"
import { SessionTodo } from "@gtaqcode/schema/session-todo"
import { Skill } from "@gtaqcode/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@gtaqcode/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@gtaqcode/core/command"),
    import("@gtaqcode/core/integration/connection"),
    import("@gtaqcode/core/credential"),
    import("@gtaqcode/core/filesystem"),
    import("@gtaqcode/core/integration"),
    import("@gtaqcode/core/location"),
    import("@gtaqcode/llm"),
    import("@gtaqcode/core/permission"),
    import("@gtaqcode/core/v1/permission"),
    import("@gtaqcode/core/project/copy"),
    import("@gtaqcode/core/pty"),
    import("@gtaqcode/core/project/schema"),
    import("@gtaqcode/core/reference"),
    import("@gtaqcode/core/session/input"),
    import("@gtaqcode/core/session/message"),
    import("@gtaqcode/core/session/todo"),
    import("@gtaqcode/core/session/prompt"),
    import("@gtaqcode/core/skill"),
    import("@gtaqcode/core/v2-schema"),
    import("@gtaqcode/core/schema"),
    import("@gtaqcode/core/workspace"),
  ])
