...
import { InvalidRequestError } from "@gtaqcode/protocol/errors"
import { SchemaErrorMiddleware } from "@gtaqcode/protocol/middleware/schema-error"
export { SchemaErrorMiddleware } from "@gtaqcode/protocol/middleware/schema-error"
