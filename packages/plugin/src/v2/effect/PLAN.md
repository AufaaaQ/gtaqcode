...
- Effect plugins import `@gtaqcode/plugin/v2/effect`, not `@gtaqcode/core`.
- Public domain values use generated `@gtaqcode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@gtaqcode/plugin/v2/effect`.
