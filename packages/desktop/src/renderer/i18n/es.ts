export const dict = {
  ...
  "desktop.updater.none.message": "Ya estÃ¡s usando la versiÃ³n mÃ¡s reciente de GTAQCODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versiÃ³n {{version}} de GTAQCODE. Â¿Quieres instalarla y reiniciar?",
