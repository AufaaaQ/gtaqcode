export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von GTAQCODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von GTAQCODE wurde heruntergeladen. M̦chten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'GTAQCODE' zu verwenden.",
