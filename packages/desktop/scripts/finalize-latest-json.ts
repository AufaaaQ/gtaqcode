...
const releaseId = process.env.GTAQCODE_RELEASE
if (!releaseId) throw new Error("GTAQCODE_RELEASE is required")

const version = process.env.GTAQCODE_VERSION
if (!version) throw new Error("GTAQCODE_VERSION is required")
...
const macxTarGz = "GTAQCODE-desktop-mac-x64.app.tar.gz"
const macaTarGz = "GTAQCODE-desktop-mac-arm64.app.tar.gz"
