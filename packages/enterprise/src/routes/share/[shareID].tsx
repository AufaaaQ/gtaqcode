import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@gtaqcode/sdk/v2"
import { SessionTurn } from "@gtaqcode/session-ui/session-turn"
import { SessionReview } from "@gtaqcode/session-ui/session-review"
import { DataProvider } from "@gtaqcode/session-ui/context"
import { FileComponentProvider } from "@gtaqcode/ui/context/file"
import { WorkerPoolProvider } from "@gtaqcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@gtaqcode/ui/logo"
import { IconButton } from "@gtaqcode/ui/icon-button"
import { ProviderIcon } from "@gtaqcode/ui/provider-icon"
import { iife } from "@gtaqcode/core/util/iife"
...
import { MessageNav } from "@gtaqcode/session-ui/message-nav"
import { FileSSR } from "@gtaqcode/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@gtaqcode/session-ui/pierre/worker").then((m) => ({
