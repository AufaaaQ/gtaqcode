...
Desktop application and browser-based app issues, including `GTAQCODE web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core GTAQCODE server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

GTAQCODE Zen, GTAQCODE Go, and billing issues.
