...
Use this folder for locale-specific translation guidance that supplements `.GTAQCODE/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/GTAQCODE/pull/12345

## Do Not Translate (Locale Additions)

- `GTAQCODE` (preserve casing)
