...
- PR #15835: https://github.com/anomalyco/GTAQCODE/pull/15835

## Do Not Translate (Locale Additions)

- `GTAQCODE` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `GTAQCODE` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `GTAQCODE` in prose, `GTAQCODE` only for exact technical identifiers
...
- Avoid changing `GTAQCODE` to `GTAQCODE` inside commands, URLs, package names, or code literals
