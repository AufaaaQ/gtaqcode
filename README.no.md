...
brew install anomalyco/tap/GTAQCODE # macOS og Linux (anbefalt, alltid oppdatert)
brew install GTAQCODE              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
GTAQCODE er ogsÃ¥ tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/GTAQCODE/releases) eller [GTAQCODE.ai/download](https://GTAQCODE.ai/download).
...
1. `$GTAQCODE_INSTALL_DIR` - Egendefinert installasjonsmappe
...
GTAQCODE har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://GTAQCODE.ai/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer GTAQCODE, [**se dokumentasjonen**](https://GTAQCODE.ai/docs).

### Bidra

Hvis du vil bidra til GTAQCODE, les [contributing docs](./CONTRIBUTING.md) fÃ¸r du sender en pull request.

### Bygge pÃ¥ GTAQCODE

Hvis du jobber med et prosjekt som er relatert til GTAQCODE og bruker "GTAQCODE" som en del av navnet; for eksempel "GTAQCODE-dashboard" eller "GTAQCODE-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av GTAQCODE-teamet og ikke er tilknyttet oss pÃ¥ noen mÃ¥te.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/GTAQCODE) | [X.com](https://x.com/GTAQCODE)
