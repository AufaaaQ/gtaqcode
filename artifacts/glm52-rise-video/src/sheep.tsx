...
export function NZSheep() {
  ...
  // slow Ken Burns push-in (scale up only â€” never reveals an edge)
    ...
    <AbsoluteFill style={{ background: "#0c0c0c", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 500, color: c.dim, letterSpacing: 1 }}>JUN 22â€“28, 2026</div>
        </div>

        {/* bottom block */}
        <div>
          <div style={{ fontSize: 23, fontWeight: 600, color: c.dim, letterSpacing: 2, marginBottom: 8 }}>
            GTAQCODE GO Â· NEW ZEALAND
          </div>
          <div
            style={{
              fontSize: 168,
          ...
          >
            <div style={{ color: c.dim }}>40.9B tokens Ã· 23.6M sheep Â· last week</div>
            <div style={{ color: c.white }}>GTAQCODE.ai/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
