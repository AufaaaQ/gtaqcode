...
// stats.GTAQCODE.ai design tokens (light theme)
const c = {
  bg: "#ffffff",
  ink: "#161616",
  muted: "#5c5c5c",
...
// verified: GTAQCODE Go, week of Jun 22-28, 2026 (2026-W26). share = % of 19.64T total Go tokens.
const bars = [
    ...
    <AbsoluteFill style={{ background: c.bg, color: c.ink, fontFamily: MONO, padding: 72, boxSizing: "border-box" }}>
      <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 500, color: c.faint, letterSpacing: 1 }}>JUN 22â€“28, 2026</div>
        </div>

        {/* headline (static) */}
        <div style={{ marginTop: 50 }}>
          <div style={{ fontSize: 23, fontWeight: 600, color: c.muted, letterSpacing: 2 }}>
            GTAQCODE GO Â· SHARE OF TOKENS
          </div>
          <div
            ...
            return (
              <div key={b.label} style={{ display: "flex", alignItems: "center", gap: 18 }}>
                ...
                <div style={{ position: "relative", flex: 1, height: 48 }}>
                  {/* dotted 100% track â€” height is a multiple of the 12px tile, anchored bottom, so dots never clip */}
                  <div
                    style={{
                      position: "absolute",
                      inset: 0,
        ...
        >
          <div style={{ display: "inline-flex", alignItems: "center", gap: 9, color: c.muted }}>
            ...
            DeepSeek V4 Flash Â· 9.48T tokens Â· 83.6M requests
          </div>
          <div style={{ color: c.ink }}>GTAQCODE.ai/data</div>
        </div>
      </div>
    </AbsoluteFill>
  )
