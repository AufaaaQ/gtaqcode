...
// verified: GTAQCODE Go (tier=Go, dataset=zen), June 1-30, 2026.
// 72.78T tokens Â· 651.4M requests Â· 11.42M sessions -> rounded headline figures.
    ...
    <AbsoluteFill style={{ background: c.bg, color: c.ink, fontFamily: MONO, padding: 72, boxSizing: "border-box" }}>
      <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ fontSize: 25, fontWeight: 600, color: c.muted, letterSpacing: 3 }}>GTAQCODE GO Â· JUNE 2026</div>
